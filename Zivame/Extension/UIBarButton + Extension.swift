...
//  Zivame
//
//  Created by Kandavel Umapathy on 26/08/21.
//
...
extension UIBarButtonItem {
    ...
    func addBadge(number: Int, withOffset offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.red, andFilled filled: Bool = true) {
        ...
        badge.drawCircleAtLocation(location, withRadius: radius, andColor: UIColor.clear, filled: filled)
        ...
        label.frame = CGRect(origin: CGPoint(x: location.x - 16, y: offset.y), size: CGSize(width: 20, height: 16))
